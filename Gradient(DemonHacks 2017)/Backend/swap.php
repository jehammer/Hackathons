<?php
	...
	if(isset($_POST["usernameA"]) && isset($_POST["usernameB"])){
		if(swapped_in_past_24_hours($link, $_POST["usernameA"], $_POST["usernameB"])){
			echo($_POST["usernameA"]." and ".$_POST["usernameB"]." have swapped in the past 24 hours!");
		}else{
			add_transaction($link, $_POST["usernameA"], $_POST["usernameB"]);
			add_to_feed($link, $_POST["usernameA"], get_most_recent_postID($link, $_POST["usernameB"]));
			add_to_feed($link, $_POST["usernameB"], get_most_recent_postID($link, $_POST["usernameA"]));
			swap_colors($link, $_POST["usernameA"], $_POST["usernameB"]);
		}
	}
?>